...
public struct TabView<Content: View>: View, AnyLVGLWidget {
  ...
  func new(_ renderer: LVGLRenderer, _ parent: UnsafeMutablePointer<lv_obj_t>) -> UnsafeMutablePointer<lv_obj_t> {
    ...
    lv_obj_set_style_text_font(buttons, tokmak_lv_font_montserrat(14), UInt32(LV_PART_ITEMS))
    ...
    lv_obj_set_style_text_font(buttons, tokmak_lv_font_montserrat(16), checkedSelector)
    lv_obj_set_style_text_decor(buttons, lv_text_decor_t(LV_TEXT_DECOR_UNDERLINE), checkedSelector)
