...
public extension FiberReconciler {
  ...
  final class Fiber {
    ...
    init<V: View>(
      ...
      typeInfo = TokmakCore.typeInfo(of: V.self)
    ...
    private func bindProperties(
      ...
      for property in typeInfo.properties where property.type is DynamicProperty.Type {
        ...
        bindProperties(to: &value, TokmakCore.typeInfo(of: property.type), environment)
    ...
    private func updateDynamicProperties(
      ...
      for property in typeInfo.properties where property.type is DynamicProperty.Type {
        ...
        updateDynamicProperties(of: &value, TokmakCore.typeInfo(of: property.type))
        // swiftlint:disable:next force_cast
    ...
    init<A: App>(
      ...
      element = rootElement
      typeInfo = TokmakCore.typeInfo(of: A.self)
    ...
    init<S: Scene>(
      ...
      self.element = element
      self.preferenceParent = preferenceParent
      typeInfo = TokmakCore.typeInfo(of: S.self)
