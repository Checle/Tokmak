...
public class FiberNode {
  ...
  /// Retained StateBox<T> instances keyed by their source declaration.
  public var stateSlots: [StateKey: UnsafeMutableRawPointer] = [:]
  public var scrollTargetIDs: [TokmakIdentityKey] = []

  /// Renderer-internal cached integer state (e.g. active tab index). -1 = unset.
  public var cachedIntState: Int = -1
