...
final class StackTests: XCTestCase {
  func testVStack() async {
    await compare(size: .init(width: 500, height: 500)) {
      ...
      TokmakStaticHTML.VStack {
        TokmakStaticHTML.Rectangle().fill(TokmakStaticHTML.Color(white: 0))
        TokmakStaticHTML.Rectangle().fill(TokmakStaticHTML.Color(white: 127 / 255))
      }
    }
  }
  ...
  func testVStackSpacing() async {
    await compare(size: .init(width: 500, height: 500)) {
      ...
      TokmakStaticHTML.VStack(spacing: 0) {
        TokmakStaticHTML.Rectangle().fill(TokmakStaticHTML.Color(white: 0))
        TokmakStaticHTML.Rectangle().fill(TokmakStaticHTML.Color(white: 127 / 255))
      }
    }
  ...
  func testHStackSpacing() async {
    await compare(size: .init(width: 500, height: 500)) {
      ...
      TokmakStaticHTML.HStack(spacing: 0) {
        TokmakStaticHTML.Rectangle().fill(TokmakStaticHTML.Color(white: 0))
        TokmakStaticHTML.Rectangle().fill(TokmakStaticHTML.Color(white: 127 / 255))
      }
    }
  ...
  func testVStackAlignment() async {
    for (nativeAlignment, tokamakAlignment) in SwiftUI.HorizontalAlignment.allCases {
      await compare(size: .init(width: 500, height: 500)) {
        ...
        TokmakStaticHTML.VStack(alignment: tokamakAlignment) {
          TokmakStaticHTML.Rectangle().fill(TokmakStaticHTML.Color(white: 0))
          TokmakStaticHTML.Rectangle().fill(TokmakStaticHTML.Color(white: 127 / 255))
            .frame(width: 50)
        }
  ...
  func testHStackAlignment() async {
    for (nativeAlignment, tokamakAlignment) in SwiftUI.VerticalAlignment.allCases {
      await compare(size: .init(width: 500, height: 500)) {
        ...
        TokmakStaticHTML.HStack(alignment: tokamakAlignment) {
          TokmakStaticHTML.Rectangle().fill(TokmakStaticHTML.Color(white: 0))
          TokmakStaticHTML.Rectangle().fill(TokmakStaticHTML.Color(white: 127 / 255))
            .frame(height: 50)
        }
