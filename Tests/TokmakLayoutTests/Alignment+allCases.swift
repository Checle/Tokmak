...
extension SwiftUI.HorizontalAlignment {
  static var allCases: [(SwiftUI.HorizontalAlignment, TokmakStaticHTML.HorizontalAlignment)] {
    [(.leading, .leading), (.center, .center), (.trailing, .trailing)]
  }
}

extension SwiftUI.VerticalAlignment {
  static var allCases: [(SwiftUI.VerticalAlignment, TokmakStaticHTML.VerticalAlignment)] {
