...
#if os(macOS)
import SwiftUI
@_spi(TokmakStaticHTML) import TokmakStaticHTML
import XCTest

func compare<A: SwiftUI.View, B: TokmakStaticHTML.View>(
  size: CGSize,
  @SwiftUI.ViewBuilder _ native: () -> A,
  @TokmakStaticHTML.ViewBuilder to tokamak: () -> B
) async {
...
private func render<V: TokmakStaticHTML.View>(
  size: CGSize,
  @TokmakStaticHTML.ViewBuilder _ view: () -> V
) async -> Data {
